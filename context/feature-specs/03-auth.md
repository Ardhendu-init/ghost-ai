...
- large screens: two-panel layout with visual impact
- left panel: gradient background (cyan to indigo-purple), compelling headline, motivational tagline, "A WISE QUOTE" label at top
- right panel: elevated dark surface with centered Clerk form
- small screens: form only (full width, dark background)
- rounded border around the entire two-panel container on large screens
- keep both panels dark-themed using design system colors and gradients
